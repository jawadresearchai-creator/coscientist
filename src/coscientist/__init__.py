...
subscription. Judgment work is emitted as persistent paper-scoped Director
actions/tickets and may be drained by a reasoning/repair plane when available.
"""
